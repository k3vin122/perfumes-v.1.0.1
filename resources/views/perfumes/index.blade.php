    ...
    @foreach ($perfumes as $perfume)
      <div class="col-12 col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm">
          @if ($perfume->imagen)
            <img src="{{ asset('storage/app/public/' . $perfume->imagen) }}" 
                 class="card-img-top" 
                 alt="Imagen de {{ $perfume->producto }}" 
                 style="height: 200px; object-fit: cover;">
          @else
            <div class="bg-secondary d-flex align-items-center justify-content-center" style="height: 200px; color: white;">
              Sin imagen
            </div>
          @endif
...
<p>Ruta: {{ $perfume->imagen }}</p>
          ...
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text mb-1"><strong>Precio:</strong> ${{ number_format($perfume->precio, 2, ',', '.') }}</p>
